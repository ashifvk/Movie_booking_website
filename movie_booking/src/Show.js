...
export default function Show() {
  ...
  const search = () => {
    ...
    //   setState(response.data.data)
    // }).catch((error) => { console.log(error); })
    axios.post('http://127.0.0.1:8000/api/MovieSearchAPIView', data).then((response) => {
      console.log(response.data.data);
  ...
  return (
    ...
    <div className='main4'>
      <Nav />
      <div class="container">
        <input class="form-control mr-sm-2 showsearch" type="search" placeholder="Search" aria-label="Search" name='query' onChange={input}></input>
                  ...
                  {role == 'admin' ?
                    <div class="col-lg-6">
                      <div class="card mb-3 yy" style={{ maxWidth: '540px' }}>
                        <div class="row no-gutters">
                          <div class="col-md-4">
                            <img src={`login/media/${value.image}`} alt="..." class="card-img" height="230px"></img>
                          </div>
                          <div class="col-md-8">
                            <div class="card-body">
                    ...
                    <div class="col-lg-6">
                      <div class="card mb-3 yy" style={{ maxWidth: '540px' }}>
                        <div class="row no-gutters">
                          <div class="col-md-4">
                            <img src={`login/media/${value.image}`} alt="..." class="card-img" height="200px"></img>
                          </div>
                          <div class="col-md-8">
                            <div class="card-body">
                              <h5 class="card-title">{value.filmName}</h5>
                    ...
                    {role == 'admin' ?
                      <div class="col-lg-6">
                        <div class="card mb-3 yy" style={{ maxWidth: '540px' }}>
                          <div class="row no-gutters">
                            <div class="col-md-4">
                              <img src={`login/${value.image}`} alt="..." class="card-img" height="230px"></img>
                            </div>
                            <div class="col-md-8">
                              <div class="card-body">
                                <h5 class="card-title">{value.filmName}</h5>
